            ...
            <div class="row">
                ...
                <div class="subscribe scrollme">
                    ...
                    <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                        <h4 class="subscribe-title">Email Woro-Woro!</h4>
                        ...
                        <div class="sub-title">Dadio member bene iso sinau bareng</div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="https://api.whatsapp.com/send?phone=6281946224134&text=Alasan%20Jadi%20Member%20?%20............"
                                class="title" target="_blank">0819 4622 4134</a>
                            <p class="sub-title">Nomere Mimin</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title" style="font-size: 14px;">programmerbanyuwangi@gmail.com</a>
                            <p class="sub-title">Emaille Mimin</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">Alamat Ngumpul</a>
                            <p class="sub-title">Deloken nang google map</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2019 <a href="?page=home" class="sub-footer__link">Programmerbanyuwangi</a>
                        Designed by <a href="https://pixelon.co.id" target="_blank">Digital Pixelon</a>
                    </span>
