                        ...
                        <div class="row table-cell">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="slider-content align-center">
                                    ...
                                    <h1 class="slider-content-title" data-swiper-parallax="-100">KOMUNITAS
                                        PROGRAMMER BANYUWANGI</h1>
                                    <h5 class="slider-content-text c-gray" data-swiper-parallax="-200">Belajar
                                        programming bareng di banyuwangi</h5>

                                    <div class="main-slider-btn-wrap" data-swiper-parallax="-300">

                                        <a href="" class="btn btn-medium btn--dark btn-hover-shadow   js-open-aside">
                                            <span class="text">Gabung Yuk</span>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-5 table-cell">
                                    <div class="slider-content">
                                        <h3 class="slider-content-title" data-swiper-parallax="-100"><span class="c-dark">Ngobar With Kloso</span>
                                            Belajar Web Design Bareng Kloso dan KPB
                                          </h3>
                                        <h6 class="slider-content-text" data-swiper-parallax="-200">
                                           @Stikom_Banyuwangi_R_2.1 <br>
                                          Setiap Kamis<br>
                                           Pk 16.30 Wib
                                        </h6>
                                        ...
                                        <div class="main-slider-btn-wrap" data-swiper-parallax="-300">
                                            ...
                                            <a href="https://api.whatsapp.com/send?phone=6281946224134&text=Saya%20mau%20ikut%20belajar%20bareng%20web%20design%20with%20kloso%2021%20feb%2C%20nama%20saya%20......%20dari%20......%20alsan%20ikut%20........" class="btn btn-medium btn--dark btn-hover-shadow">
                                                <span class="text">Ikut Aja Yuk...</span>
                                                <span class="semicircle"></span>
                                            </a>
                </div>
            ...
            <div class="row table-cell">
                <div class="col-lg-6 table-cell">
                    ...
                    <div class="slider-content">
                        ...
                        <h5 class="slider-content-text" data-swiper-parallax="-200">An
                            effective social
                            strategy
                ...
                <div class="col-lg-12">
                    ...
                    <div class="slider-content align-center">
                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Email
                            Marketing</h3>
                        <h5 class="slider-content-text" data-swiper-parallax="-200">We
                            create tailored
                            marketing
                            campaigns for each segment
                            of your audience to help advertise products and
                        ...
                        <div class="main-slider-btn-wrap" data-swiper-parallax="-300">
                            ...
                            <a href="07_service_email_marketing.html" class="btn btn-medium btn--dark btn-hover-shadow">
                                <span class="text">learn more</span>
                                <span class="semicircle"></span>
                            </a>
        ...
        <div class="container table full-height">
            <div class="row table-cell">
                ...
                <div class="col-lg-6 table-cell">
                    <div class="slider-content">
                        ...
                        <h5 class="slider-content-text" data-swiper-parallax="-200">Pay
                            Per Click has
                            an instant
                            impact and gives
                            your brand a much larger reach and exposure as a result
                            of first page
                            exposure on
                        ...
                        <div class="main-slider-btn-wrap" data-swiper-parallax="-300">
                            ...
                            <a href="08_service_ppc_management.html" class="btn btn-medium btn--dark btn-hover-shadow">
                                <span class="text">learn more</span>
                                <span class="semicircle"></span>
                            </a>

                            <a href="08_service_ppc_management.html" class="btn btn-medium btn-border btn-hover-shadow">
                                <span class="text">GET STARTED</span>
                                <span class="semicircle"></span>
                            </a>
            ...
            <div class="slider-slides">
                <a href="#" class="slides-item bg-border-color main-slider-bg-light">
                    <div class="content">
                        <div class="text-wrap">
                            <h4 class="slides-title">Gabung Yuk Di</h4>
                            <div class="slides-sub-title">Komunitas Programmer Banyuwangi</div>
                        </div>
                ...
                <a href="#" class="slides-item bg-primary-color">
                    <div class="content">
                        <div class="text-wrap">
                            <h4 class="slides-title">Scedhule Kegiatan</h4>
                            <div class="slides-sub-title">Komunitas Programmer Banyuwangi</div>
                        </div>
                ...
                <a href="#" class="slides-item bg-secondary-color">
                    <div class="content">
                        <div class="text-wrap">
                            <h4 class="slides-title">Learn HTML</h4>
                        </div>
                ...
                <a href="#" class="slides-item bg-orange-color">
                    <div class="content">
                        <div class="text-wrap">
                            <h4 class="slides-title">Learn CSS</h4>
                        </div>
                ...
                <a href="#" class="slides-item bg-green-color">
                    <div class="content">
                        <div class="text-wrap">
                            <h4 class="slides-title">Learn PHP</h4>
                        </div>
                            ...
                            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-12 col-sm-12">
                                <div class="seo-score-content align-center">
                                    ...
                                    <div class="heading align-center">
                                        ...
                                        <p class="heading-text">Check your website’s SEO problems
                                            for free!</p>
                                    </div>
...
<div class="bgbg" style="background:#eeeeee;">
        <div class="container" >
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">Ngobar With Kloso
                                           </h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <p class="heading-text"> Belajar Web Design Bareng Kloso dan KPB
                                    </p>
                                </div>
                                ...
                                <ul class="list list--secondary">
                                    <li>
                                        ...
                                        <a href="#">@Stikom_Banyuwangi_R_2.1
                                          </a>
                                    </li>
                                    <li>
                                        <i class="seoicon-check"></i>
                                        <a href="#">Setiap Kamis</a>
                                    </li>
                                    <li>
                                        <i class="seoicon-check"></i>
                                        <a href="#"> Pk 16.30 Wib</a>
                                    </li>
                                </ul>


                                <a href="https://api.whatsapp.com/send?phone=6281946224134&text=Saya%20mau%20ikut%20belajar%20bareng%20web%20design%20with%20kloso%2021%20feb%2C%20nama%20saya%20......%20dari%20......%20alsan%20ikut%20........" class="btn btn-medium btn--primary btn-hover-shadow">
                                    <span class="text">Ikut Belajar</span>
                                    <span class="semicircle"></span>
                                </a>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="offers-thumb">
                                    <img src="img/slider2.png" alt="offers">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding">
                        <div class="content theme-module centered-on-mobile medium-padding100">
                            <div class="heading">
                                ...
                                <p class="heading-text">Qolor sit amet, consectetuer adipiscing
                                    elit, sed diam nonummy
                                    nibham liber
                                    tempor cum soluta nobis eleifend option congue nihil uarta
                                    decima et quinta.
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="info-box--standard-centered">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <p class="text">Dolor sit amet, consectetuer adipiscing
                                            elit.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="info-box--standard-centered">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <p class="text">Eodem modo typi, qui nunc nobis videntur
                                            parum.
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="recent-case align-center">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                            <div class="heading align-center">
                                <h4 class="h1 heading-title">Recent Post On Instagram</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                                <p class="heading-text">Kepoin Programmer Banyuwangi Di Instagram
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <a href="https://www.instagram.com/programmer_banyuwangi/?hl=id" target="_blank">
                            <div class="case-item-wrap">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="img/1.png" alt="our case">
                                        </div>
                                        <h6 class="case-item__title"><a href="#">Pembelajar Seumur Hidup</a></h6>
                                    </div>
                                </div>
                        </a>
                        <a href="https://www.instagram.com/programmer_banyuwangi/?hl=id" target="_blank">
                            <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="img/2.png" alt="our case">
                                    </div>
                                    <h6 class="case-item__title">Budaya Berkomputer</h6>
                                </div>
                            </div>
                        </a>
                        <a href="https://www.instagram.com/programmer_banyuwangi/?hl=id" target="_blank">
                            <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled"
                                        data-offset="5">
                                        <img src="img/3.png" alt="our case">
                                    </div>
                                    <h6 class="case-item__title">Self Learning</h6>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="heading">
                            <h4 class="h1 heading-title">Programmer Banyuwangi</h4>
                            <div class="heading-line">
                                <span class="short-line bg-yellow-color"></span>
                                <span class="long-line bg-yellow-color"></span>
                            </div>
                            <p class="heading-text c-white">Kumpul bareng kita yog, belajar bareng pemrogramman di
                                banyuwangi
                            </p>
                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="testimonial-slider-item swiper-slide">
                                        <div class="testimonial-content">
                                            <p class="text" data-swiper-parallax="-200">Nggk Usah Banyak Pikir,
                                                Langsung Join Aja
                                            </p>
                                            <a href="#" class="author" data-swiper-parallax="-150">Pendapat</a>
                                            <a href="#" class="company" data-swiper-parallax="-150">Mimin</a>
                                    ...
                                    <div class="testimonial-slider-item swiper-slide">
                                        <div class="testimonial-content">
                                            <p class="text" data-swiper-parallax="-200">Manusia Pembelajar, belajar
                                                dimana saja , bebaskan dirimu
                                                dengan koding bareng
                                            </p>
                                            <a href="#" class="author" data-swiper-parallax="-150">Pendapat </a>
                                            <a href="#" class="company" data-swiper-parallax="-150">Koncone Mimin</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="heading">
                        ...
                        <a href="#" class="read-more">Read Our Blog
                            ...
                            <article class="hentry post">
                                ...
                                <div class="post__content">
                                    <h2 class="post__title entry-title">
                                        <a href="15_blog_details.html">Qemonstraverunt legere
                                            lius</a>
                                    </h2>

                                    <p class="post__text">Sequitur mutationem consuetudium
                                        lectorum quam nunc
                                        putamus.</p>
